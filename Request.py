...
class Request:
    def __init__(self, NUM_REQUESTS, NODES, REQUESTS_ENTRY_NODES, SEED=4, CAPACITY_REQUIREMENT_LB=10,
                 CAPACITY_REQUIREMENT_UB=31, BW_REQUIREMENT_LB=20, BW_REQUIREMENT_UB=21, DLY_REQUIREMENT_LB=10,
