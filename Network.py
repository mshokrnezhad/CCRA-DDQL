...
class Network:
    def __init__(self, NUM_NODES, NUM_PRIORITY_LEVELS=1, SWITCH="srv_plc", SEED=4, NUM_TIERS=3, TIER_HEIGHT=100,
                 TIER_WIDTH=20, DC_CAPACITY_UNIT=100, DC_COST_UNIT=50, LINK_BW_LB=250, LINK_BW_UB=300, LINK_COST_LB=10,
                 LINK_COST_UB=20, BURST_SIZE_LIMIT=100, PACKET_SIZE=10):
