...
class Single_Game_VNF_Placement(object):
    def __init__(self, NUM_NODES, NUM_REQUESTS, NUM_SERVICES, NUM_PRIORITY_LEVELS, NUM_GAMES, SEEDS, MIN_NUM_REQUESTS=0, MAX_NUM_REQUESTS=0, MODE="none"):
        self.SWITCH = "vnf_plc"
        ...
        self.SEEDS = SEEDS
        self.FILE_NAME = "K" + str(NUM_PRIORITY_LEVELS) + "_S" + str(NUM_SERVICES) + "_M" + MODE
    ...
    def rnd_alloc(self):
        ...
        append_list_to_file(reqs, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_reqs")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_reqs")
        append_list_to_file(avg_ofs, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_avg_ofs")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_avg_ofs")
        append_list_to_file(avg_dlys, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_avg_dlys")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_avg_dlys")
        append_list_to_file(dc_vars, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_dc_vars")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_rnd_dc_vars")
    ...
    def cm_alloc(self):
        ...
        append_list_to_file(reqs, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_reqs")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_reqs")
        append_list_to_file(avg_ofs, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_avg_ofs")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_avg_ofs")
        append_list_to_file(avg_dlys, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_avg_dlys")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_avg_dlys")
        append_list_to_file(dc_vars, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_dc_vars")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_cm_dc_vars")
    ...
    def dm_alloc(self):
        ...
        append_list_to_file(reqs, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_reqs")
        append_list_to_file(avg_ofs, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_avg_ofs")
        append_list_to_file(avg_dlys, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_avg_dlys")
        append_list_to_file(dc_vars, "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_dc_vars")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_reqs")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_avg_ofs")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_avg_dlys")
        append_list_to_file("\n", "results/" + self.FILE_NAME + "/", "d_" + self.FILE_NAME + "_dm_dc_vars")
